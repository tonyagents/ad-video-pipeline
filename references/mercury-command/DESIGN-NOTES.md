# Mercury /command — design reference for the MoonAgents ad creator

Source: https://mercury.com/command (saved 2026-06-17). Mercury's "Command" is an
AI-finance product page — conceptually the closest competitor look to MoonAgents,
...
> assets in a MoonPay ad. Substitute licensed/again-brand equivalents (see below).
...
- **Conversational UI cards.** The hero/feature visuals are chat-style cards showing the
  ...
  numbers. Demo-as-design, exactly the MoonAgents artifact story.
...
## How to apply to MoonAgents ads (recommended, brand-safe)
...
- Use MoonPay purple `#7D00FF` where Mercury uses `#5266EB`.
