"""Build a musicless sonic identity for the 33.1s Moongate character film.

The arc is physical rather than musical: fragmented alerts -> gate impact ->
four real-world ambience zones -> tactile product ticks -> Moongate signature.
"""
...
# Moongate signature: the low pillars appear, then the upper arch resolves.
...
out_path = os.path.join(os.path.dirname(__file__), '..', 'public', 'moongate-soundscape.wav')
